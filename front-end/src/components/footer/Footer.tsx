        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-400">
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <p className="hover:text-mainColor transition-colors">(629) 555-0129</p>
              </div>
              <div className="flex items-center space-x-3 group">
                <FaEnvelope className="text-mainColor group-hover:scale-110 transition-transform" />
                <p className="hover:text-mainColor transition-colors">SwiftBuy@kinbo.com</p>
              </div>
            </div>
            <div className="flex space-x-4 justify-center lg:justify-start">
              <a href="#" className="text-gray-400 hover:text-mainColor transition-colors">
          ...
          <div className="text-center lg:text-left">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <HashLink smooth to="/#newArrivals" 
                  className="text-gray-400 hover:text-mainColor transition-colors inline-block">
                  New Arrivals
                </HashLink>
              </li>
          ...
          <div className="text-center lg:text-left">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to={user?._id ? `/profile` : `/register`}
                  className="text-gray-400 hover:text-mainColor transition-colors inline-block">
                  My Account
                </Link>
              </li>
              <li>
                <Link to={user?._id ? `/cart` : "/register"}
                  className="text-gray-400 hover:text-mainColor transition-colors inline-block">
                  Shopping Cart
                </Link>
              </li>
              <li>
                <Link to={user?._id ? `/wishlist` : "/register"}
                  className="text-gray-400 hover:text-mainColor transition-colors inline-block">
                  Wishlist
                </Link>
              </li>
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="grid grid-cols-2 gap-4">
              <img src="/Method=Visa.png" alt="Visa" className="hover:scale-105 transition-transform" />
              <img src="/Method=Mastercard.png" alt="Mastercard" className="hover:scale-105 transition-transform" />
              <img src="/Method=ApplePay.png" alt="Apple Pay" className="hover:scale-105 transition-transform" />
              <img src="/Method=Discover.png" alt="Discover" className="hover:scale-105 transition-transform" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-4">
              <a href="#" className="text-gray-400 hover:text-mainColor transition-colors text-sm">
                Privacy Policy
              </a>
